...
import com.teachCode.springSecurity.service.impl.RefreshTokenService;
...
public class AuthenticationController {
    ...
    public ResponseEntity<JwtAuthenticationResponse> refreshToken(@RequestBody Map<String ,String> request){
        ...
        RefreshToken token=refreshTokenService.findByToken(refreshToken).orElseThrow(()-> new TokenRefreshException(refreshToken,"Refresh token not found"));
